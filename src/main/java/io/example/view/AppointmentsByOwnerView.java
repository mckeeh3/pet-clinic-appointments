...
// This is the implementation for the View Service described in your io/example/view/appointments_by_owner.proto file.
//
// As long as this file exists it will not be overwritten: you can maintain it yourself,
// or delete it so it is regenerated as needed.

public class AppointmentsByOwnerView extends AbstractAppointmentsByOwnerView {

  public AppointmentsByOwnerView(ViewContext context) {
  }
